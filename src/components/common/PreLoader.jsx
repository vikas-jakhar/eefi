...
const PreLoader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[150] flex items-center justify-center">
            <div className={`min-h-screen w-1/2 bg-light-blue z-[100] fixed top-0 left-0 transition-transform duration-500 ${hide ? '-translate-x-full' : 'translate-x-0'}`}>
            </div>
            ...
            <div className={`min-h-screen w-1/2 bg-light-blue z-[100] fixed top-0 right-0 transition-transform duration-500 ${hide ? 'translate-x-full' : 'translate-x-0'}`}>
            </div>
        </div>
    );
}
