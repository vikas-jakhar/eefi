...
const Hero = () => {
    return (
        <div className='relative pb-24 lg:pb-0' id='hero'>
            <img loading='lazy' rel="preload" as="image" className='max-w-[1210px] w-full absolute right-2 bottom-0' src={heroBg} alt="heroBg" />
            <img loading='lazy' rel="preload" as="image" className='absolute -top-4 left-0 xl:max-w-[1160px] lg:max-w-[900px] object-cover lg:h-[710px] xl:h-[810px] h-[650px] md:w-full 2xl:hidden block' src={heroVector} alt="#" />
            <Header />
            <div className='container mb-20 pb-20 lg:pb-0 lg:mb-0 relative'>
                <div className='flex lg:flex-row flex-col xl:-mt-12 relative z-[1]'>
                    ...
                    <img loading='lazy' rel="preload" as="image" className='xl:max-w-[635px] h-[502px] w-[335px] xl:h-[876px] md:max-w-[450px] md:h-auto md:w-full absolute lg:relative top-20 md:top-0 right-2 -z-10 opacity-50 sm:opacity-70 lg:opacity-100 pointer-events-none lg:pt-0 pt-9' src={heroImage} alt="heroImage" />
                </div>
            </div>
            ...
            <img loading='lazy' rel="preload" as="image" className='absolute -top-12 left-[-124px] h-[810px] w-[80%] 2xl:block hidden' src={heroVector} alt="heroVector" />
        </div>
    )
}
