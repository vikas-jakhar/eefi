...
const Hero = () => {
    return (
        <div className='relative pb-24 lg:pb-0' id='hero'>
            ...
            <img className='absolute -top-4 left-0 xl:max-w-[1160px] lg:max-w-[900px] object-cover lg:h-[710px] xl:h-[810px] h-[650px] md:w-full 2xl:hidden block' src={heroVector} alt="#" />
            <Header />
