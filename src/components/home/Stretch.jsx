...
const Stretch = () => {
    return (
        <div id='stretch' className='bg-stretch-layer md:bg-fixed bg-no-repeat bg-center bg-cover lg:pt-5 lg:h-[825px] md:h-[640px] sm:h-[556px] h-[520px] relative'>
            ...
            <img loading='lazy' rel="preload" as="image" data-aos='fade-left' className='max-w-[569px] w-1/2 md:w-[41%] lg:w-1/2 xl:w-full absolute bottom-14 right-1 xl:right-[10%] pointer-events-none' src={bear} alt="bear" />
            <img loading='lazy' rel="preload" as="image" data-aos='fade-right' className='max-w-[684px] w-7/12 md:w-1/2 lg:w-7/12 xl:w-full absolute bottom-14 left-1 xl:left-[10%] pointer-events-none' src={bull} alt="bull" />
            <img loading='lazy' rel="preload" as="image" data-aos='zoom-in' className='pointer-events-none max-w-[100px] w-[10%] sm:w-full absolute bottom-14 left-1/2 -translate-x-1/2' src={men} alt="men" />
        </div>
    )
}
